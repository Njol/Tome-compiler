...
public enum Borrowing {
	 ...
	 * <p>
	 * This is particularly useful for functions which can assign local variables of the caller function if and only if they are borrowed (as their lifespan then does not exceed
	 * the lifespan of the variables themselves).
	 */
	...
	public static @Nullable Borrowing parse(final AbstractASTElement<?> parent) {
