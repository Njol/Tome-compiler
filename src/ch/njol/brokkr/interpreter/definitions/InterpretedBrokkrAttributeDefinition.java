...
public class InterpretedBrokkrAttributeDefinition extends AbstractInterpretedBrokkrAttribute implements InterpretedAttributeDefinition {

	public InterpretedBrokkrAttributeDefinition(AttributeDeclaration declaration) {
		super(declaration);
	}
